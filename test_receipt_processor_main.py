...
def test_process_receipts__morning_valid_receipt():
    with app.test_client() as client:
...
def test_process_receipts__invalid_simple_receipt_no_retailer():
    with app.test_client() as client:
...
def test_process_receipts__invalid_simple_receipt_no_purchaseDate():
    with app.test_client() as client:
...
def test_process_receipts__invalid_simple_receipt_no_purchaseTime():
    with app.test_client() as client:
...
def test_process_receipts__invalid_simple_receipt_no_total():
    with app.test_client() as client:
...
def test_process_receipts__invalid_simple_receipt_no_items():
    with app.test_client() as client:
...
def test_process_receipts__invalid_simple_receipt_empty_items():
    with app.test_client() as client:
